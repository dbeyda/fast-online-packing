...
class PackingProblem:
    ...
    options_per_instant: int = field(init=False)
    ...
    def __post_init__(self):
        ...
        # if mandatory_packing=False, this will be one more than the argument of the generator
        self.options_per_instant = len(self.values[0])
